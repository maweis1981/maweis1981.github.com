---
title: "纯 Vibe Coding：用 Claude Code + Floniks 做 AI 时代的游戏（一步步教程）"
...
tags:
  ...
  - Agentic Coding
description: >-
  你只说"想要什么"，Claude Code 写代码、调 Floniks 生成素材、跑测试、自主迭代。本文用一整段真实的 git 历史，一步步复盘我们如何用纯 vibe coding 做出一套能在浏览器里玩的小游戏合集——从一句话加一个解谜游戏，到用文生图/图生图/去背景/TTS/文生音乐做出一个悬疑微恐视觉小说，再到系统性 debug 与一键发布。
image:
  path: /assets/img/posts/vibe-coding-game-dev/cover.png
  alt: "纯 Vibe Coding 做 AI 时代的游戏"
---

> **TL;DR**：你只说"想要什么"，Claude Code 写代码、调 Floniks 生成素材、跑测试、自主迭代。本文用一整段真实的 git 历史，一步步复盘我们如何用纯 vibe coding 做出一套能在浏览器里玩的小游戏合集——从一句话加一个解谜游戏，到用文生图/图生图/去背景/TTS/文生音乐做出一个悬疑微恐视觉小说，再到系统性 debug 与一键发布。
{: .prompt-tip }

上一篇《[AI 时代，应该有 AI 时代的游戏开发方式](/posts/ai-era-game-dev/)》讲了"为什么"。这一篇讲"怎么做"——把我们这套方式一步一步拆开，全部来自真实的 git 历史，**你能照着复现**。
...
*《小马拼图》——圆角瓦片、粗体中文标题、心数/倒计时/连胜 HUD，由 agent 按参考视频逐帧还原。*
...
*广告帧：手指演示放马 → 自动打 ✕ → 过关庆祝，画面元素全部是游戏里的真实素材。*
...
*选人界面：三位证人并排（点击前移 + 震动 + 变焦）。立绘是透明抠图，干净地叠在夜画廊背景上。*
